      ...
      <Paper>
        ...
        <Grid className={classes.market} wrap="nowrap" container direction='column' alignContent='center' justify='center' spacing={2}>
          ...
          <Grid  container direction='row' alignItems='center' spacing={2}>
            <Grid item xs={8}>
              <Typography variant='body2'>
                1. {catResponse.gdpr_top_scorers[0].Privacy_Policy_URL } 
              </Typography>
            </Grid>
          ...
          <Grid  container direction='row' alignItems='center' spacing={2}>
            <Grid item xs={8}>
              <Typography variant='body2'>
                2. {catResponse.gdpr_top_scorers[1].Privacy_Policy_URL } 
              </Typography>
            </Grid>
          ...
          <Grid container className={classes.last} direction='row' alignItems='center' spacing={2}>
            <Grid item xs={8}>
              <Typography variant='body2'>
                3. {catResponse.gdpr_top_scorers[2].Privacy_Policy_URL }
              </Typography>
            </Grid>
            <Grid item className={classes.score} xs={2}>
